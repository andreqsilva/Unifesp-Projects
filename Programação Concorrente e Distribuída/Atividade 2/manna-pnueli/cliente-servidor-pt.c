/*
  ...
  $ gcc cliente-servidor-pt.c -o cliente-servidor-pt -lpthread
  $ ./cliente-servidor-pt <numero_de_clientes>
*/
...
int main(int argc, char **argv) {
  ...
  // inicia o servidor com a thread de id 0
